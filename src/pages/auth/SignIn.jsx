        ...
        <div className='fixed w-full px-4 py-16 z-50'>
          <div className='max-w-[450px] h-[500px] mx-auto bg-black/70 text-white  '>
            <div className='mx-auto max-w-[320px] py-10 '>
              <h2 className='text-white text-3xl font-bold text-center capitalize'>Sign in</h2>
              <form className='flex flex-col w-full mx-auto' onSubmit={handleSignUp}>
                ...
                <button className='py-3 my-6 bg-rose-600 rounded font-bold capitalize '>Sign in</button>
              </form>
              ...
              <p className='text-gray-600 capitalize py-3'>new to netflix <span className='text-white'><Link to='/signup'>Sign up</Link></span></p>
            </div>
          </div>
        </div>
      </div>
